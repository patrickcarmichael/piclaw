...
const recoveryPolicyDomainSchema = registerDomainConfig<RecoveryPolicyConfig>({
  ...
  fields: {
    ...
    mutationRepetitionLimit: integerField({ key: "mutationRepetitionLimit", owner: "agent-runtime", defaultValue: 2, min: 1, max: 64, bounds: "1..64 successful identical mutations", persistence: "json-config", precedence: ["compat-env", "persisted", "default"], secretClass: "none", compatibilityEnv: [{ envKey: "PICLAW_MUTATION_REPETITION_LIMIT", replacement: "domains.recovery.mutationRepetitionLimit", removalVersion: "3.0.0", skipInvalid: true }] }),
