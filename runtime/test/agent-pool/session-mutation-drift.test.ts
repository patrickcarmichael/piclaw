...
const expectedDirect: Inventory = {
  ...
  "agent-pool.ts": { rotateSession: 1, setActiveToolsByName: 3 },
  ...
  "agent-pool/run-agent-attempt-budget.ts": { setActiveToolsByName: 4 },
  "agent-pool/run-agent-attempt-context.ts": { abort: 2 },
  "agent-pool/run-agent-orchestrator.ts": { abort: 3, clearQueue: 1, maybeAutoCompactSessionBeforePrompt: 1, prompt: 1, rotateSession: 4, setActiveToolsByName: 3 },
